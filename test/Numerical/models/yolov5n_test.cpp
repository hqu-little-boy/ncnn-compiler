...
const ReferenceModel kReference(
  YOLOV5N_PARAM_PATH, YOLOV5N_BIN_PATH, "in0", "out0", kInputShape);

TEST(NumericalModel, Yolov5nDetectionMatchesNcnn) {
