...
const ReferenceModel kReference(
  YOLOV5X_PARAM_PATH, YOLOV5X_BIN_PATH, "in0", "out0", kInputShape);

TEST(NumericalModel, Yolov5xDetectionMatchesNcnn) {
