...
const ReferenceModel kReference(
  RESNET101_PARAM_PATH, RESNET101_BIN_PATH, "in0", "out0", kInputShape);

TEST(NumericalModel, ResNet101MatchesNcnn) {
