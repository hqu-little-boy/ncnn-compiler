...
const ReferenceModel kReference(
  YOLOV5M_PARAM_PATH, YOLOV5M_BIN_PATH, "in0", "out0", kInputShape);

TEST(NumericalModel, Yolov5mDetectionMatchesNcnn) {
