...
func.func @bad_conv_result(%arg0: tensor<3x8x8xf32>) -> tensor<64x8x8xf32> {
  ...
  %0 = ncnn.conv2d %arg0, %w, %b {dilation_h = 1 : i64, dilation_w = 1 : i64, has_bias = true, kernel_h = 3 : i64, kernel_w = 3 : i64, pad_bottom = 0 : i64, pad_left = 0 : i64, pad_right = 0 : i64, pad_top = 0 : i64, stride_h = 1 : i64, stride_w = 1 : i64} : (tensor<3x8x8xf32>, tensor<64x3x3x3xf32>, tensor<64xf32>) -> tensor<64x8x8xf32>
