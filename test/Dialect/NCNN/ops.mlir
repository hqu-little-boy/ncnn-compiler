...
func.func @all_ops(%arg0: tensor<3x227x227xf32>) -> tensor<128xf32> {
  ...
  %c = ncnn.conv2d %arg0, %w, %b {dilation_h = 1 : i64, dilation_w = 1 : i64, has_bias = true, kernel_h = 3 : i64, kernel_w = 3 : i64, pad_bottom = 0 : i64, pad_left = 0 : i64, pad_right = 0 : i64, pad_top = 0 : i64, stride_h = 2 : i64, stride_w = 2 : i64} : (tensor<3x227x227xf32>, tensor<64x3x3x3xf32>, tensor<64xf32>) -> tensor<64x113x113xf32>
  // CHECK: ncnn.relu
  %r = ncnn.relu %c : (tensor<64x113x113xf32>) -> tensor<64x113x113xf32>
  // CHECK: ncnn.pool2d
  // CHECK-SAME: kind = 0 : i64
  %p = ncnn.pool2d %r {include_pad = false, kernel_h = 3 : i64, kernel_w = 3 : i64, kind = 0 : i64, mode = 0 : i64, pad_bottom = 0 : i64, pad_left = 0 : i64, pad_mode = 0 : i64, pad_right = 0 : i64, pad_top = 0 : i64, stride_h = 2 : i64, stride_w = 2 : i64} : (tensor<64x113x113xf32>) -> tensor<64x56x56xf32>
  // CHECK: ncnn.split
  ...
  %g = ncnn.pool2d %d {include_pad = false, kernel_h = 0 : i64, kernel_w = 0 : i64, kind = 1 : i64, mode = 1 : i64, pad_bottom = 0 : i64, pad_left = 0 : i64, pad_mode = 0 : i64, pad_right = 0 : i64, pad_top = 0 : i64, stride_h = 1 : i64, stride_w = 1 : i64} : (tensor<128x56x56xf32>) -> tensor<128xf32>
  // CHECK: ncnn.softmax
