...
func.func @normalize(%arg0: tensor<3x4x5xf32>) -> tensor<16x2x3xf32> {
  ...
  %depthwise_weight = arith.constant dense<0.000000e+00> : tensor<3x1x3x3xf32>
  %depthwise = ncnn.convolution_depthwise %arg0, %depthwise_weight {dilation_h = 1 : i64, dilation_w = 1 : i64, has_bias = false, kernel_h = 3 : i64, kernel_w = 3 : i64, pad_bottom = -233 : i64, pad_left = -233 : i64, pad_right = -233 : i64, pad_top = -233 : i64, stride_h = 2 : i64, stride_w = 2 : i64} : (tensor<3x4x5xf32>, tensor<3x1x3x3xf32>) -> tensor<3x2x3xf32>
