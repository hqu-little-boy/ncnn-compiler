...
int main() {
  ...
  check(write_bytes(empty_bin_path, {}), "empty bin fixture written");
  auto empty_input_bin =
    load_text("empty-input-bin", kInputGraph, empty_bin_path.string());
  check(empty_input_bin && empty_input_bin->get_weights_loaded(),
  ...
  check(!missing_bin && contains(missing_bin.error(), "file size"),
  ...
  check(!empty_convolution && contains(empty_convolution.error(), "EOF"),
  ...
  check(write_bytes(truncated_bin_path, truncated_weight),
  ...
  check(
    !truncated_weight_graph && contains(truncated_weight_graph.error(), "EOF"),
  ...
  check(write_bytes(missing_padding_path, float16_without_padding),
  ...
  check(write_bytes(float16_path, float16_weight),
  ...
  check(write_bytes(int8_path, int8_weight), "int8 bin fixture written");
  ...
  check(write_bytes(int8_top_scale_path, int8_with_top_scale),
  ...
  check(write_bytes(int8_without_scales_path, int8_without_scales),
  ...
  check(!int8_without_scales_graph &&
  ...
  check(dynamic_graph && dynamic_graph->get_weights_loaded() &&
