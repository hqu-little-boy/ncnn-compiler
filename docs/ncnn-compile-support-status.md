...
`PP-OCRv6_tiny_rec`、`PP-OCRv6_small_rec_int8`、`PP-OCRv6_medium_rec`、`PP-OCRv6_medium_rec_int8`、`PP-OCRv6_tiny_det`、`PP-OCRv6_small_det`、
...
- `models/dynamic_pp_ocr_test.cpp`：十四个 fixed-rank 动态产物：PP-LCNet doc/textline、AngleNet、
  PP-OCRv5 mobile/server rec、PP-OCRv6 tiny/medium rec、PP-OCRv6 small/medium rec INT8、
