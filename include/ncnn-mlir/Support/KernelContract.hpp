...
inline constexpr llvm::StringLiteral kPackSchema = "ncnn.pack_schema";
inline constexpr llvm::StringLiteral kPackRawBytes = "ncnn.pack_raw_bytes";
inline constexpr llvm::StringLiteral kPackTileK = "ncnn.pack_tile_k";
inline constexpr llvm::StringLiteral kPackRuntime = "ncnn.pack_runtime";
inline constexpr llvm::StringLiteral kPackedWeight = "ncnn.packed_weight";
